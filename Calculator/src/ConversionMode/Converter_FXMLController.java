...
public class Converter_FXMLController implements Initializable {
    ...
    public void write_key(KeyEvent event) {
        ...
        if (event.getCode().isDigitKey()) {
            ...
            /*
            * this condition for handling the user not to write before - sign in the temp mode
            */
            if ((pos != 0 && minus_flag != 1) || (pos != 0 && minus_flag == 1) || (pos == 0 && minus_flag != 1)) {
                ...
                case MINUS:
                    if (conv_mode_detect == 2) {
                        ...
                        if (ta1.getText().charAt(0) != '-') {
                            neg_but.fire();// to use the same logic which won't let the user write anything before - sign
                        }
                    }
                    break;
                case SUBTRACT:
    ...
    private void ta_write(ActionEvent event) {
        ...
        if (bstr.equals("-")) {
            ...
            if (pos != 0) {
                ...
                if (ta1.getText().charAt(pos-1) == '-') {//if you what you will delete is - sign reset the minus flag
